...
@interface RLCircularProgressLayer : CALayer
...
@implementation RLCircularProgressLayer
...
@interface RLCircularProgressView () <CAAnimationDelegate>
#else
@interface RLCircularProgressView ()
#endif

@end

@implementation RLCircularProgressView

+ (void)initialize {
    if (self == [RLCircularProgressView class]) {
        RLCircularProgressView *circularProgressViewAppearance = [RLCircularProgressView appearance];
...
+ (Class)layerClass {
    return [RLCircularProgressLayer class];
}

- (RLCircularProgressLayer *)circularProgressLayer {
    return (RLCircularProgressLayer *)self.layer;
}
...
@implementation RLLabeledCircularProgressView
